	  ...
	  <div class="detailed-text">
		...
		function apply(){
		     ...
		     var txt3 = "<a style='float: left; clear: both;' href='javascript: next_instructors();'><img style='width:30px; height: 30px;' src='/dance-studio-new/images/More.png' /></a>";
		...
		<a href="/dance-studio-new?p=instructors">
		  <img src="/dance-studio-new/images/Man1.png">
		...
		<a href="/dance-studio-new?p=instructors">
		  <img src="/dance-studio-new/images/Woman.png">
		  <div class="instructor-text">
		...
		<a href="/dance-studio-new?p=instructors">
		  <img src="/dance-studio-new/images/Man2.png">
		  <div class="instructor-text">
                    <h3>Hungry Jake</h3>
